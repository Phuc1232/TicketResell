...
from api.controllers.notification_controller import NotificationPreferencesSchema
spec.components.schema("NotificationPreferences", schema=NotificationPreferencesSchema)
